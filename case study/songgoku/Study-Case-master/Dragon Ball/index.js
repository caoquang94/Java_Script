...
let shooter = document.getElementById('player-controlled-blaster');
...
//this is where you can make monster fly, it's speed , monter will be removed if they are "dead-monster" or they will win if the reach the left side of screen!
...
// this function perform between laser and monster, where they meet , radius if they meet. you have to adjust it correctly else it won't be fit with images.
...
//after you lose. there will stop everything and an alert box will appeare to let you know your score!
  ...
  //call and play game. after you click playgame. letters inside screen will disappeare, you can move character, music will play and monster will arrive. 